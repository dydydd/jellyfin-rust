...
const UPSERT_SQL: &str = r"
    WITH input AS (
        ...
        FROM jsonb_to_recordset($2::jsonb) AS stream(
            ...
            color_primaries text, color_space text, color_transfer text,
        ...
        INSERT INTO jellyfin.media_streams (
            ...
            title, time_base, codec_time_base, color_primaries, color_space,
        ...
        ON CONFLICT (item_id, stream_index) DO UPDATE SET
            (stream_type, codec, language, channel_layout, profile, aspect_ratio, path,
             ...
             color_primaries, color_space, color_transfer, dv_version_major,
            ...
            (EXCLUDED.stream_type, EXCLUDED.codec, EXCLUDED.language,
             ...
             EXCLUDED.codec_time_base, EXCLUDED.color_primaries, EXCLUDED.color_space,
             EXCLUDED.color_transfer, EXCLUDED.dv_version_major,
