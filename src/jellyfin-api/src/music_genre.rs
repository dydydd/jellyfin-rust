...
pub(crate) async fn list(
    ...
    let mut item_query = ItemValueQuery {
        ...
        // Official ByName queries run on SQLite: Take(0) is empty while
        // Take(negative) translates to its unlimited LIMIT form.
        limit: query
            .limit
...
async fn project_music_genre_without_user(
    state: &AppState,
