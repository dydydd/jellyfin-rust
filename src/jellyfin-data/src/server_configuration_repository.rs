    ...
    pub async fn update_startup_configuration(
        ...
        let statement = Statement::from_sql_and_values(
            ...
            RETURNING id, server_name, ui_culture, metadata_country_code,
                ...
                enable_normalized_item_by_name_ids, enable_case_sensitive_item_ids,
                metadata_path, metadata_options, sort_replace_characters,
    ...
    pub async fn update_server_configuration(
        ...
        let statement = Statement::from_sql_and_values(
            ...
            SET server_name = $1,
                ...
                enable_case_sensitive_item_ids = $42,
                metadata_options = $43
            WHERE id = 1
            RETURNING id, server_name, ui_culture, metadata_country_code,
                preferred_metadata_language, is_startup_wizard_completed,
            ...
            [
                ...
                update.enable_case_sensitive_item_ids.into(),
                update.metadata_options.into(),
            ],
        );
        server_configuration::Model::find_by_statement(statement)
            .one(self.database.as_ref())
