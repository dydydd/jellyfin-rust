...
impl MigrationTrait for Migration {
        ...
        manager
            ...
            .execute_unprepared(
                ...
                ALTER TABLE jellyfin.server_configuration
                    ADD COLUMN IF NOT EXISTS plugin_repositories jsonb NOT NULL DEFAULT '[]'::jsonb;
                ...
                BEGIN
                    IF NOT EXISTS (
                        ...
                        ALTER TABLE jellyfin.server_configuration
                            ADD CONSTRAINT server_configuration_plugin_repositories_array
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            ...
            .execute_unprepared(
                "ALTER TABLE jellyfin.server_configuration \
                 DROP COLUMN IF EXISTS plugin_repositories;",
            )
            .await?;
        Ok(())
    }
